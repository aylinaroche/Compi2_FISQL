...
//se comenta esto
  ...
  static final public void NOMBREETIQUETA() throws ParseException {
  ...
  static final public void MAESTRO() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case etqA:
      M();
      MAESTRO();
  ...
  static final public void M() throws ParseException {
    ...
    jj_consume_token(db);
    jj_consume_token(etqC);
    jj_consume_token(nombreA);
    jj_consume_token(cadena);
    jj_consume_token(nombreC);
    jj_consume_token(etqA);
    jj_consume_token(db);
    jj_consume_token(etqC);
    jj_consume_token(etqA);
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x20002,0x10000000,};
   }
