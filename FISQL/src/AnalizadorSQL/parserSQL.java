...
//se comenta esto
    ...
    try {
      ...
      case detener:
        ...
        jj_consume_token(puntoComa);
                                       nuevo.insertar(new Nodo(i.image)); nuevo.insertar(new Nodo(";"));
        break;
      case retorno:
        i = jj_consume_token(retorno);
        n = RETORNAR();
        jj_consume_token(puntoComa);
                                                    nuevo.insertar(new Nodo(i.image)); nuevo.insertar(n); nuevo.insertar(new Nodo(";"));
        break;
      case id:
 ...
 Nodo nuevo = new Nodo("CREAR"); Nodo s,p,l; Token i,j;
    try {
      ...
      case base_datos:
        ...
        j = jj_consume_token(id);
        jj_consume_token(puntoComa);
                                                  nuevo.insertar(new Nodo(i.image)); nuevo.insertar(new Nodo(j.image));nuevo.insertar(new Nodo(";"));
        break;
      case tabla:
        ...
        jj_consume_token(puntoComa);
                                                                                     nuevo.insertar(new Nodo(i.image)); nuevo.insertar(new Nodo(j.image)); nuevo.insertar(new Nodo("(")); nuevo.insertar(s);nuevo.insertar(new Nodo(")"));
        break;
      case objeto:
      ...
      case procedimiento:
        ...
        jj_consume_token(llaveC);
                                                                                                                   nuevo.insertar(new Nodo(i.image)); nuevo.insertar(new Nodo(j.image));  nuevo.insertar(new Nodo("("));nuevo.insertar(s);  nuevo.insertar(new Nodo("){")); nuevo.insertar(l); nuevo.insertar(new Nodo("}"));
        break;
      case funcion:
        ...
        l = SENTENCIA();
        jj_consume_token(llaveC);
                                                                                                                      nuevo.insertar(new Nodo(i.image)); nuevo.insertar(new Nodo("(")); nuevo.insertar(new Nodo(j.image));  nuevo.insertar(new Nodo("(")); nuevo.insertar(s); nuevo.insertar(new Nodo(")"));nuevo.insertar(p); nuevo.insertar(new Nodo("{")); nuevo.insertar(l); nuevo.insertar(new Nodo("}"));
        break;
      default:
        jj_la1[8] = jj_gen;
        jj_consume_token(-1);
 ...
 Nodo nuevo = new Nodo("PARAMETROSP"); Nodo s,c,p,q; Token i;
    try {
      ...
      case coma:
        ...
        c = COMPLEMENTO();
        p = PARAMETROSP();
                                                                         nuevo.insertar(new Nodo(",")); nuevo.insertar(s); nuevo.insertar(new Nodo(i.image)); nuevo.insertar(c); nuevo.insertar(p);
        break;
      default:
        jj_la1[9] = jj_gen;
                 {if (true) return null;}
 ...
 Nodo nuevo = new Nodo("PARAMETROSVARP"); Nodo s,p; Token i;
    try {
      ...
      case coma:
        ...
        i = jj_consume_token(idVar);
        p = PARAMETROSVARP();
                                                               nuevo.insertar(new Nodo(",")); nuevo.insertar(s); nuevo.insertar(new Nodo(i.image)); nuevo.insertar(p);
        break;
      default:
        jj_la1[11] = jj_gen;
                 {if (true) return null;}
    ...
    try {
      ...
      case usuario:
        ...
        c = jj_consume_token(cadena);
                                                                             nuevo.insertar(new Nodo(i.image)); nuevo.insertar(new Nodo(j.image)); nuevo.insertar(new Nodo("cambiar password=")); nuevo.insertar(new Nodo(k.image)); nuevo.insertar(new Nodo(c.image));
        break;
      default:
        jj_la1[12] = jj_gen;
        jj_consume_token(-1);
 ...
 Nodo nuevo = new Nodo("DML"); Nodo s,p,d; Token i,j;
    try {
      ...
      case actualizar:
        ...
        d = DONDE();
        jj_consume_token(puntoComa);
                                                                                                                                                                nuevo.insertar(new Nodo(i.image)); nuevo.insertar(new Nodo("tabla")); nuevo.insertar(new Nodo(j.image)); nuevo.insertar(new Nodo("(")); nuevo.insertar(s); nuevo.insertar(new Nodo(") valores (")); nuevo.insertar(p); nuevo.insertar(new Nodo(")")); nuevo.insertar(d); nuevo.insertar(new Nodo(";"));
        break;
      case borrar:
        ...
        d = DONDE();
        jj_consume_token(puntoComa);
                                                                  nuevo.insertar(new Nodo(i.image)); nuevo.insertar(new Nodo("en tabla")); nuevo.insertar(new Nodo(j.image)); nuevo.insertar(d); nuevo.insertar(new Nodo(";"));
        break;
      case seleccionar:
 ...
 Nodo nuevo = new Nodo("TIPOINSERTAR"); Nodo s; Token i;
    try {
      ...
      case valores:
        ...
        s = LISTAVALORES();
        jj_consume_token(parentesisC);
                                                                     nuevo.insertar(new Nodo("valores(")); nuevo.insertar(s);nuevo.insertar(new Nodo(")"));
        break;
      default:
        jj_la1[16] = jj_gen;
                 {if (true) return null;}
 ...
 Nodo nuevo = new Nodo("LISTAVALORESP"); Nodo s,l; Token i;
    try {
      ...
      case coma:
        ...
        s = OPERACION();
        l = LISTAVALORESP();
                                                       nuevo.insertar(new Nodo(",")); nuevo.insertar(s); nuevo.insertar(l);
        break;
      default:
        jj_la1[19] = jj_gen;
                 {if (true) return null;}
 ...
 Nodo nuevo = new Nodo("ORDENAR"); Nodo s; Token i;
    try {
      ...
      case ordenar:
        ...
        i = jj_consume_token(id);
        s = TIPOORDENAR();
                                                        nuevo.insertar(new Nodo("ordenar por")); nuevo.insertar(new Nodo(i.image)); nuevo.insertar(s);
        break;
      default:
        jj_la1[22] = jj_gen;
                 {if (true) return null;}
 ...
 Nodo nuevo = new Nodo("ASIGNACION"); Nodo s,p; Token i;
    try {
      ...
      p = OPERACION();
      jj_consume_token(puntoComa);
                                                                  nuevo.insertar(new Nodo(i.image)); nuevo.insertar(s);nuevo.insertar(new Nodo("=")); nuevo.insertar(p);nuevo.insertar(new Nodo(";"));
                 {if (true) return nuevo;}
    } catch (ParseException e) {
        Token t;
    t = getNextToken();
 ...
 Nodo nuevo = new Nodo("VAR"); Nodo s; Token i;
    try {
      ...
      case punto:
        ...
        i = jj_consume_token(id);
                               nuevo.insertar(new Nodo(".")); nuevo.insertar(new Nodo(i.image));
        break;
      default:
        jj_la1[27] = jj_gen;
                 {if (true) return null;}
 ...
 Nodo nuevo = new Nodo("SI"); Nodo s,m,o; Token i;
    try {
      ...
      jj_consume_token(llaveC);
      o = SINO();
                                                                                                         nuevo.insertar(new Nodo(i.image)); nuevo.insertar(new Nodo("(")); nuevo.insertar(s); nuevo.insertar(new Nodo(")")); nuevo.insertar(new Nodo("{"));nuevo.insertar(m); nuevo.insertar(new Nodo("}")); nuevo.insertar(o);
                 {if (true) return nuevo;}
    } catch (ParseException e) {
        Token t;
    t = getNextToken();
 ...
 Nodo nuevo = new Nodo("SELECCIONA"); Nodo c,s; Token i;
    try {
      ...
      c = CASO();
      jj_consume_token(llaveC);
                                                                                                nuevo.insertar(new Nodo(i.image)); nuevo.insertar(new Nodo("(")); nuevo.insertar(s); nuevo.insertar(new Nodo("){")); nuevo.insertar(c); nuevo.insertar(new Nodo("}"));
                 {if (true) return nuevo;}
    } catch (ParseException e) {
        Token t;
    t = getNextToken();
 ...
 Nodo nuevo = new Nodo("E"); Nodo s; Token i;
    ...
    case verdadero:
      i = jj_consume_token(verdadero);
                               nuevo.insertar(new Nodo(i.image, "verdadero"));
      break;
    case falso:
      i = jj_consume_token(falso);
                           nuevo.insertar(new Nodo(i.image, "falso"));
      break;
    case parentesisA:
      jj_consume_token(parentesisA);
      s = AND();
  ...
  static {
   ...
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0xcf2,0x0,0xcf2,0xcf2,0x0,0x7c000,0x7c000,0x0,0x0,0x0,0x0,0x0,0x0,0x180000,0x400000,0x0,0x4000000,0x0,0x1800700,0x0,0x8000000,0x0,0x10000000,0xc0000000,0x0,0x0,0x0,0x0,0x1,0xc,0x0,0x0,0x0,0x800,0x3000,0x3000,0x1800700,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1800700,};
   }
